...
@class SharedAppDatabaseCompanion, SharedAppDatabaseQueries, SharedKoin_coreBeanDefinition<T>, SharedKoin_coreCallbacks<T>, SharedKoin_coreExtensionManager, SharedKoin_coreInstanceContext, SharedKoin_coreInstanceFactory<T>, SharedKoin_coreInstanceFactoryCompanion, SharedKoin_coreInstanceRegistry, SharedKoin_coreKind, SharedKoin_coreKoin, SharedKoin_coreKoinDefinition<R>, SharedKoin_coreLevel, SharedKoin_coreLockable, SharedKoin_coreLogger, SharedKoin_coreModule, SharedKoin_coreParametersHolder, SharedKoin_corePropertyRegistry, SharedKoin_coreScope, SharedKoin_coreScopeDSL, SharedKoin_coreScopeRegistry, SharedKoin_coreScopeRegistryCompanion, SharedKoin_coreSingleInstanceFactory<T>, SharedKotlinArray<T>, SharedKotlinByteArray, SharedKotlinByteIterator, SharedKotlinEnum<E>, SharedKotlinEnumCompanion, SharedKotlinException, SharedKotlinIllegalStateException, SharedKotlinLazyThreadSafetyMode, SharedKotlinNothing, SharedKotlinRuntimeException, SharedKotlinThrowable, SharedKotlinUnit, SharedKotlinx_serialization_coreSerialKind, SharedKotlinx_serialization_coreSerializersModule, SharedLaunch, SharedLinks, SharedLinksCompanion, SharedPatch, SharedPatchCompanion, SharedRocketLaunch, SharedRocketLaunchCompanion, SharedRuntimeAfterVersion, SharedRuntimeBaseTransacterImpl, SharedRuntimeExecutableQuery<__covariant RowType>, SharedRuntimeQuery<__covariant RowType>, SharedRuntimeTransacterImpl, SharedRuntimeTransacterTransaction, SharedSpaceXApi, SharedStately_concurrencyThreadLocalRef<T>;

@protocol SharedAppDatabase, SharedDatabaseDriverFactory, SharedKoin_coreKoinComponent, SharedKoin_coreKoinExtension, SharedKoin_coreKoinScopeComponent, SharedKoin_coreQualifier, SharedKoin_coreScopeCallback, SharedKotlinAnnotation, SharedKotlinComparable, SharedKotlinIterator, SharedKotlinKAnnotatedElement, SharedKotlinKClass, SharedKotlinKClassifier, SharedKotlinKDeclarationContainer, SharedKotlinLazy, SharedKotlinx_serialization_coreCompositeDecoder, SharedKotlinx_serialization_coreCompositeEncoder, SharedKotlinx_serialization_coreDecoder, SharedKotlinx_serialization_coreDeserializationStrategy, SharedKotlinx_serialization_coreEncoder, SharedKotlinx_serialization_coreKSerializer, SharedKotlinx_serialization_coreSerialDescriptor, SharedKotlinx_serialization_coreSerializationStrategy, SharedKotlinx_serialization_coreSerializersModuleCollector, SharedPlatform, SharedRuntimeCloseable, SharedRuntimeQueryListener, SharedRuntimeQueryResult, SharedRuntimeSqlCursor, SharedRuntimeSqlDriver, SharedRuntimeSqlPreparedStatement, SharedRuntimeSqlSchema, SharedRuntimeTransacter, SharedRuntimeTransacterBase, SharedRuntimeTransactionCallbacks, SharedRuntimeTransactionWithReturn, SharedRuntimeTransactionWithoutReturn;
...
- (instancetype)initWithDatabaseDriverFactory:(id<SharedDatabaseDriverFactory>)databaseDriverFactory api:(SharedSpaceXApi *)api __attribute__((swift_name("init(databaseDriverFactory:api:)"))) __attribute__((objc_designated_initializer));
...
*/
- (void)getLaunchesForceReload:(BOOL)forceReload completionHandler:(void (^)(NSArray<SharedRocketLaunch *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getLaunches(forceReload:completionHandler:)")));
@property (readonly) SharedSpaceXApi *api __attribute__((swift_name("api")));
@end
...
- (instancetype)initWithDriver:(id<SharedRuntimeSqlDriver>)driver __attribute__((swift_name("init(driver:)"))) __attribute__((objc_designated_initializer));
- (void)insertLaunchFlightNumber:(int64_t)flightNumber missionName:(NSString *)missionName details:(NSString * _Nullable)details launchSuccess:(SharedLong * _Nullable)launchSuccess launchDateUTC:(NSString *)launchDateUTC patchUrlSmall:(NSString * _Nullable)patchUrlSmall patchUrlLarge:(NSString * _Nullable)patchUrlLarge articleUrl:(NSString * _Nullable)articleUrl __attribute__((swift_name("insertLaunch(flightNumber:missionName:details:launchSuccess:launchDateUTC:patchUrlSmall:patchUrlLarge:articleUrl:)")));
- (void)removeAllLaunches __attribute__((swift_name("removeAllLaunches()")));
- (SharedRuntimeQuery<SharedLaunch *> *)selectAllLaunchesInfo __attribute__((swift_name("selectAllLaunchesInfo()")));
- (SharedRuntimeQuery<id> *)selectAllLaunchesInfoMapper:(id (^)(SharedLong *, NSString *, NSString * _Nullable, SharedLong * _Nullable, NSString *, NSString * _Nullable, NSString * _Nullable, NSString * _Nullable))mapper __attribute__((swift_name("selectAllLaunchesInfo(mapper:)")));
@end

__attribute__((swift_name("DatabaseDriverFactory")))
@protocol SharedDatabaseDriverFactory
@required
...
@interface SharedIOSDatabaseDriverFactory : SharedBase <SharedDatabaseDriverFactory>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (id<SharedRuntimeSqlDriver>)createDriver __attribute__((swift_name("createDriver()")));
@end
...
- (instancetype)initWithFlightNumber:(int64_t)flightNumber missionName:(NSString *)missionName details:(NSString * _Nullable)details launchSuccess:(SharedLong * _Nullable)launchSuccess launchDateUTC:(NSString *)launchDateUTC patchUrlSmall:(NSString * _Nullable)patchUrlSmall patchUrlLarge:(NSString * _Nullable)patchUrlLarge articleUrl:(NSString * _Nullable)articleUrl __attribute__((swift_name("init(flightNumber:missionName:details:launchSuccess:launchDateUTC:patchUrlSmall:patchUrlLarge:articleUrl:)"))) __attribute__((objc_designated_initializer));
...
@property (readonly) SharedLong * _Nullable launchSuccess __attribute__((swift_name("launchSuccess")));
...
- (instancetype)initWithPatch:(SharedPatch * _Nullable)patch article:(NSString * _Nullable)article __attribute__((swift_name("init(patch:article:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedLinksCompanion *companion __attribute__((swift_name("companion")));
- (SharedLinks *)doCopyPatch:(SharedPatch * _Nullable)patch article:(NSString * _Nullable)article __attribute__((swift_name("doCopy(patch:article:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="article")
*/
@property (readonly) NSString * _Nullable article __attribute__((swift_name("article")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="patch")
*/
@property (readonly) SharedPatch * _Nullable patch __attribute__((swift_name("patch")));
@end
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedLinksCompanion *shared __attribute__((swift_name("shared")));
...
*/
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Patch")))
@interface SharedPatch : SharedBase
- (instancetype)initWithSmall:(NSString * _Nullable)small large:(NSString * _Nullable)large __attribute__((swift_name("init(small:large:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) SharedPatchCompanion *companion __attribute__((swift_name("companion")));
- (SharedPatch *)doCopySmall:(NSString * _Nullable)small large:(NSString * _Nullable)large __attribute__((swift_name("doCopy(small:large:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Patch.Companion")))
@interface SharedPatchCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) SharedPatchCompanion *shared __attribute__((swift_name("shared")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
